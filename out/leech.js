...
cljs.reader.match_int = function(a) {
  ...
  if(cljs.core.truth_(cljs.core.not.call(null, function() {
    var a = cljs.core.undefined_QMARK_.call(null, c);
...
cljs.reader.read_keyword = function(a) {
  var b = cljs.reader.read_token.call(null, a, cljs.reader.read_char.call(null, a)), b = cljs.core.re_matches.call(null, cljs.reader.symbol_pattern, b), c = cljs.core.nth.call(null, b, 0, null), d = cljs.core.nth.call(null, b, 1, null), e = cljs.core.nth.call(null, b, 2, null), f = function() {
    var a = cljs.core.not.call(null, cljs.core.undefined_QMARK_.call(null, d));
    return cljs.core.truth_(a) ? 0 < d.length : a
  }();
  return cljs.core.truth_(function() {
    var a = cljs.core.truth_(f) ? ":/" === d.substring(d.length - 2, d.length) : f;
    if(cljs.core.truth_(a)) {
      return a
    }
    a = ":" === e[e.length - 1];
    return cljs.core.truth_(a) ? a : cljs.core.not.call(null, -1 === c.indexOf("::", 1))
  }()) ? cljs.reader.reader_error.call(null, a, "Invalid token: ", c) : cljs.core.truth_(f) ? cljs.core.keyword.call(null, d.substring(0, d.indexOf("/")), e) : cljs.core.keyword.call(null, c)
};
  ...
  return cljs.core.truth_(function() {
    return cljs.core.truth_(function() {
      if(cljs.core.truth_(c)) {
        ...
        return cljs.core.truth_(a) ? cljs.core.not.call(null, cljs.core.is_proto_.call(null, c)) : a
      }
      return c
